...
const BasicDetailsForm = ({ form, currentUser, getStaffMember }) => {
  console.log("getStaffMember", getStaffMember?.data);
        ...
        <div className="px-4">
          <Row gutter={24}>
            <Col xl={12} lg={12} md={12} sm={24} xs={24}>
              <Form.Item
                initialValue={getStaffMember?.data?.firstName}
                name="firstname"
                rules={[
                  {
                    required: true,
            ...
            <Col xl={12} lg={12} md={12} sm={24} xs={24}>
              <Form.Item
                initialValue={getStaffMember?.data?.lastName}
                name="lastname"
                rules={[
                  {
                    required: true,
            ...
            <Col xl={12} lg={12} md={12} sm={24} xs={24}>
              <Form.Item
                initialValue={getStaffMember?.data?.phone?.number}
                name="phone"
                label={
              ...
              >
                <PhoneNumber
                  ...
                  rules={[
                    {
                      message:
                        "Please enter the contact number of service user",
                    },
                    () => ({
                      validator(_, value) {
                        if (!value) {
            ...
            <Col xl={12} lg={12} md={12} sm={24} xs={24}>
              <Form.Item
                name="email"
                initialValue={getStaffMember?.data?.email}
